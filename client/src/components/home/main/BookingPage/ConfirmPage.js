    ...
    <>
      ...
      <Dialog open={open} onClose={handleClose} className={classes.root}>
        <List>
          ...
          <ListItem>
            <Typography variant="h5">Address: {props.order.exactAddress}</Typography>
          </ListItem>
          <Divider />
          <ListItem>
            <Typography variant="h5">Cleaning type: {props.order.cleaningType}</Typography>
          </ListItem>
          <ListItem>
            <Typography variant="h5">Small rooms: {props.order.smallRoomCount}</Typography>
          </ListItem>
          <ListItem>
            <Typography variant="h5">Large rooms: {props.order.largeRoomCount}</Typography>
          </ListItem>
          <ListItem>
            <Typography variant="h5">Toilets: {props.order.toiletCount}</Typography>
          </ListItem>
          <Divider />
          <ListItem>
